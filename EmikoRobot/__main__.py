...
PM_START_TEXT = """
*Hello {} !*
✪ I'm Ultron group management bot [✨](https://telegra.ph/file/d90d9959709e60a93bd8a.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        ...
        query.message.edit_text(
            text="*๏ Ultron support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Ultron.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/ultron_support"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/ultronupdates"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="sena-ex", url="https://t.me/nn948"),
